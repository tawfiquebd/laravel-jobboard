    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
            <div class="mb-12">
                ...
                <div class="mb:flex-grow mr-8 mt-2 flex items-center justify-start">
            ...
            <div class="-my-6">
                <div class="flex flex-wrap md:flex-nowrap">
                    ...
                    <div class="w-full md:w-1/4 pl-4">
                        ...
                        <p class="loading-relaxed text-base">
                            <strong>Location: </strong> {{ $listing->location }} <br>
                            <strong>Company: </strong> {{ $listing->company }} <br>
                        </p>

                        <a href="{{ route('listings.apply', $listing->slug) }}" class="block text-center my-4 tracking-wide bg-white font-medium title-font py-2 border border-indigo-500 hover:bg-indigo-500 hover:text-white uppercase">Apply Now</a>
                    </div>
                </div>
            </div>
        </div>
